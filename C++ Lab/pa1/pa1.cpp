...
void statsRoom(const int boxes[], int num_prisoners, int num_trials)
{
    ...
    cout << "The number of prisoners who find their slips: " <<score; 
    cout << endl;
    cout << "Number of loops: " << num_of_loop<<endl; /* Please replace this to your own code */
